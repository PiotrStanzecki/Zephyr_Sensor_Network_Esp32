...
struct attribute s_sensors_attributes[] = {
  {"Humidity", "double", NULL, offsetof(struct sensors, Humidity), 0, false},
  {"Light_lvl", "double", NULL, offsetof(struct sensors, Light_lvl), 0, false},
  {"Temp", "double", NULL, offsetof(struct sensors, Temp), 0, false},
  {NULL, NULL, NULL, 0, 0, false}
};
struct attribute s_leds_attributes[] = {
  {"led1_on", "bool", NULL, offsetof(struct leds, led1_on), 0, false},
  {"red_lvl", "int", NULL, offsetof(struct leds, red_lvl), 0, false},
  {"green_lvl", "int", NULL, offsetof(struct leds, green_lvl), 0, false},
  {"blue_lvl", "int", NULL, offsetof(struct leds, blue_lvl), 0, false},
  {NULL, NULL, NULL, 0, 0, false}
};
...
static void http_ev_handler(struct mg_connection *c, int ev, void *ev_data) {
  ...
  if (ev == MG_EV_POLL && c->is_websocket == 0 && c->is_listening == 0 &&
      c->data[0] == CONN_ACTION) {
  ...
  } else if ((ev == MG_EV_READ || ev == MG_EV_CLOSE) &&
              c->is_websocket == 0 && c->is_listening == 0 &&
...
#if WIZARD_ENABLE_SNTP
#if WIZARD_SNTP_TYPE == 1
  g_mgr.ifp->enable_req_sntp = true;
#endif
